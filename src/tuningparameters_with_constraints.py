...
Determines values for the parameters epsilon, report threshold, report probability
and sampling probability for a given dataset (100k or 400k) and a given
percentile (determined via the global threshold input).
First round is for the unconstrained communication case whrere we iterate over
a set of values for the switch memory S.
Second round is with unconstrained switch memory and we iterate over an array of
values for the communication budget.
...
Returns: The calculated parameters are written to a csv file in ../parameters/.
...
if __name__ == "__main__":
    ...
    pcap_path, glob_thresh_T = parser()

    # set file paths depending on which dataset we use
    ...
    # set arrays to iterate over
    comm_budget_array = [1000,1100,1200,1300,1400,1500, 1750, 2000, 2250, 2500, 3000,3500,4000,4500,5000,6000,7000,8000,9000,10000]
    switch_mem_array = [100,125,150,200,250,300 ,400,500, 600, 800, 1000, 1500, 2000, 2500, 3000, 4000, 5000, 10000, 20000, 30000]

    # switch memory constraints tuning
    ...
    # communication bandwidth constraints evaluation
